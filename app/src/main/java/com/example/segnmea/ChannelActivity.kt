...
class ChannelActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.saveButton.setOnClickListener {
            ...
            editor.putString("channel1", binding.channel1EditText.text.toString())
            editor.putString("channel2", binding.channel2EditText.text.toString())
            editor.putString("channel3", binding.channel3EditText.text.toString())
            editor.putString("channel4", binding.channel4EditText.text.toString())
            editor.apply()
