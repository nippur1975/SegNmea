...
public final class CustomInfoWindowBinding implements ViewBinding {
  ...
  private CustomInfoWindowBinding(@NonNull LinearLayout rootView, @NonNull TextView snippet,
  ...
  public static CustomInfoWindowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CustomInfoWindowBinding((LinearLayout) rootView, snippet, title);
    }
